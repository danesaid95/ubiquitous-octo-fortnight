...
export const clientLogos = [
  ...
  { name: "Rhode", logo: "/images/clients/rhode-logo.svg" },
  { name: "Maëlys", logo: "/images/clients/maelys-logo.svg" },
  { name: "Phlur", logo: "/images/clients/phlur-logo.svg" },
  { name: "Salt & Stone", logo: "/images/clients/salt-stone-logo.svg" },
  { name: "Primally Pure", logo: "/images/clients/primally-pure-logo.svg" },
  { name: "Spoiled Child", logo: "/images/clients/spoiled-child-logo.svg" },
  { name: "Function of Beauty", logo: "/images/clients/function-of-beauty-logo.svg" },
  { name: "DRESSX", logo: "/images/clients/dressx-logo.svg" },
];
